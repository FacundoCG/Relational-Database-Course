...
echo "$($PSQL "SELECT year, name FROM teams FULL JOIN games on teams.team_id=games.winner_id WHERE round = 'Final' AND teams.team_id=games.winner_id ORDER BY year")"
